...
# Test para la creación de un crédito
...
# Test para obtener todos los créditos
@patch("services.credit_services.Credito")
...
# Test para obtener un crédito por su ID
@patch("services.credit_services.db.session")
@patch("services.credit_services.Credito")
...
# Test para actualizar un crédito
@patch("services.credit_services.db.session")
@patch("services.credit_services.Credito")
def test_update_credito(mock_model, mock_session):
    ...
    data_update = {"monto": 400, "plazo": 6, "fecha_otorgamiento": date.today().isoformat()}
...
# Test para obtener estadísticas de créditos
